...
import { GenericHttpException } from 'src/application';
...
export class HttpExceptionsFilter implements ExceptionFilter {
  ...
  constructor(
    ...
    const genericHttpException = isGenericHttpException
      ? exception.getBody()
      : {};

    const statusCode = isGenericHttpException
      ? exception?.getStatus()
    ...
    httpAdapter.reply(
      ctx.getResponse(),
      { ...genericHttpException, ...httpExceptionBody },
      statusCode,
    );
  }
}
